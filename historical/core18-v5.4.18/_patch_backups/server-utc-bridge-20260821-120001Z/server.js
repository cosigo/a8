...
async function control(req, res) {
  ...
  try {
    ...
    switch (action) {
      ...
      case 'alignLocal': core.alignClockToLocalMilliseconds(data.msSinceMidnight, data.source || 'BROWSER LOCAL WALL CLOCK'); break;
...
server.listen(PORT, HOST, () => {
  console.log(`A8 Time Lab v5.4.18 running at http://${HOST}:${PORT}/`);
