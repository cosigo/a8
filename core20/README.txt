...
STATIC QUARTZ EXPERIMENT PATCH 01 · 2026-08-16
===============================================
This static laboratory patch does NOT change A8 core recovery, comparator, replay, telescope,
divider, clock authority, observer-cadence, or A8_TOL logic. Runtime/core version remains v5.4.18.

Added:
- public/quartz.html — Quartz Prism Length & Light Experiment v0.2 (SPECULATIVE RESEARCH)
- Main engineering page link: OPEN QUARTZ / LENGTH EXPERIMENT
- Angle Translator cross-link: QUARTZ / LENGTH EXPERIMENT
- Quartz page return links to ENGINEERING LAB and A8 ANGLE TRANSLATOR

The quartz page is an experimental evidence program only. The provisional alpha-quartz a-axis
recurrence and A8/31 = 2^31 q_a remain candidates and are not promoted to Foundation by this patch.



STATIC PATCH 02 · COSIGO GLOBAL NAVIGATION / DISCLAIMER SHELL · 2026-08-16
----------------------------------------------------------------------------
UI/static only. Core version remains v5.4.18.

Adds to all public laboratory HTML pages:
- bundled official COSIGO icon in a global top navigation bar
- exits to COSIGO Home and Contact
- links to A8 Lab Home, A8 Public Instrument and COSIGO GitHub
- common research/engineering disclaimer footer
- links to COSIGO Docs, GitHub, main-site source and Project Status

No changes to core/a8-core.js, server.js, package.json, tests, recovery math,
comparator math, replay/telescope logic, clock authority or Node scheduling.


STATIC PATCH 03 · 88-TEST ACCEPTANCE SUITE · 2026-08-16
-------------------------------------------------------
Test/verification only. Runtime/core version remains v5.4.18.

Extends the deterministic acceptance suite from 66 to 88 tests by adding 22 checks for:
- Quartz Experiment v0.2 review boundaries and cross-links
- COSIGO global navigation on all eight public lab pages
- common disclaimer/footer links and authority wording
- bundled COSIGO icon integrity
- shared responsive shell CSS
- byte-for-byte preservation of accepted core/a8-core.js and server.js hashes

No changes to core recovery/comparator math, server runtime, public pages, package.json,
replay/telescope logic, clock authority, observer cadence, or A8_TOL.

Verification note: use HTTP GET, not HEAD (-I), against this lab server for static-resource checks;
HEAD is intentionally not implemented and returns HTTP 405 Method Not Allowed.
